...
public class FilmDbStorage implements FilmStorage {
    ...
    public Film update(Film film) {
        if (isFilmExists(film.getId())) {
            ...
            throw new FilmIdException(String.format("Попытка обновить пленку с помощью " +
                    "отсутсвующий id = %d", film.getId()));
        }
    }
    ...
    public Film delete(Film film) {
        if (isFilmExists(film.getId())) {
            ...
            return film;
        } else throw new FilmIdException(String.format("Попытка удалить пленку с помощью " +
                "отсутсвующий id = %d", film.getId()));
    }
